...
import ytLogoMobile from "../images/ytMobile.png";
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black">
      ...
      <div className="flex h-8 w-20 items-center">
        ...
        <Link to="/" className="flex h-8 w-30  items-center">
          <img className="h-100% md:hidden" src={ytLogoMobile} alt="Youtube" />
          <img
            className="h-full w-full hidden md:block lg:block xl:block"
            src={ytLogo}
            alt="Youtube"
          />
        </Link>
